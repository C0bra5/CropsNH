...
public class MTEIndustrialFarm extends MTEExtendedPowerMultiBlockBase<MTEIndustrialFarm> implements ISurvivalConstructable {
    ...
    private static final IStructureDefinition<MTEIndustrialFarm> STRUCTURE_DEFINITION = StructureDefinition
        ...
        .addElement(
            ...
            buildHatchAdder(MTEIndustrialFarm.class)
                .anyOf(
                    ...
                    OutputBus,
                    Maintenance,
                    MultiAmpEnergy.or(Energy)
                )
                .casingIndex(CASING_INDEX)
                .dot(1)
                .buildAndChain(
                    onElementPass(te -> te.mCasing++, ofBlock(CropsNHBlocks.blockCasings1, 0))
                )
        )
        ...
        .addElement('U', ofChain(
            ofFrame(Materials.Wood)
        ))
        .addElement('s', lazy(a -> ofBlocksTiered(MTEIndustrialFarm::getSeedBlockTier, getSeedBedBlocks(), -1, (te, t) -> te.mSeedBedTier = t, te -> te.mSeedBedTier)))
        .build();
    ...
    public boolean checkMachine(IGregTechTileEntity aBaseMetaTileEntity, ItemStack aStack) {
        this.mSeedBedTier = -1;
        this.mGlassTier = -1;
        boolean tSuccess = STRUCTURE_DEFINITION.check( this,
            STRUCTURE_PIECE_FIRST,
        ...
        tSuccess = STRUCTURE_DEFINITION.check( this,
            STRUCTURE_PIECE_LATER,
            this.getBaseMetaTileEntity().getWorld(),
            this.getExtendedFacing(),
            this.getBaseMetaTileEntity().getXCoord(),
