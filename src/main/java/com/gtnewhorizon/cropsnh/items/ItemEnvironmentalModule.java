...
public class ItemEnvironmentalModule extends Item {
    ...
    private final static String NAME_BASE = "item." + Reference.MOD_ID.toLowerCase() + ":environmentalModule";
    ...
    private static class ModuleData {
        ...
        public ModuleData(BiomeDictionary.Type tag) {
            this.tag = tag;
            this.unlocalizedName = NAME_BASE + "."
                + tag.name()
                    .toUpperCase();
        }
        ...
        public void registerIcon(IIconRegister register) {
            this.icon = register.registerIcon(
                Reference.MOD_ID.toLowerCase() + ":environmentalModule/"
                    + tag.name()
                        .toUpperCase());
        }
    ...
    public void registerIcons(IIconRegister register) {
        ...
        this.cardIcon = register.registerIcon(Reference.MOD_ID.toLowerCase() + ":environmentalModule/blank");
