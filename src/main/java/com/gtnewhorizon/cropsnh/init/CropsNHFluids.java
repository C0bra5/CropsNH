...
public class CropsNHFluids {
    ...
    // alchool
    public final static AlcoholImpure FWheat = new AlcoholImpure(
        Reference.MOD_ID_LOWER + ":FWheat",
        40,
        "potion.alcopops");
    ...
    public final static AlcoholImpure FReed = new AlcoholImpure(
        Reference.MOD_ID_LOWER + ":FReed",
        50,
        "potion.alcopops");
    public final static AlcoholImpure SWhine = new AlcoholImpure(
        Reference.MOD_ID_LOWER + ":SWhine",
        700,
        "potion.reedwater");
    public final static AlcoholImpure Mash = new AlcoholImpure(
        Reference.MOD_ID_LOWER + ":Mash",
        25,
        "potion.reedwater");
    ...
    public final static AlcoholImpure jagi = new AlcoholImpure(
        Reference.MOD_ID_LOWER + ":jagi",
        100000,
        "potion.alcopops");
    public final static AlcoholImpure njagi = new AlcoholImpure(
        Reference.MOD_ID_LOWER + ":njagi",
        350,
        "potion.alcopops");
